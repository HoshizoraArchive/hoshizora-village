...
現在の星空Villageでは、本番と同じログイン・プロフィール・投稿状態で差分を確認するため、Deploy Previewも本番Supabaseへ接続する運用があります。**Preview上の投稿・編集・削除・ブロック・通報などは本番データへ影響し得るため、確認時はProductionと同じ注意で扱ってください。**
