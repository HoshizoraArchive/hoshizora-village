export const ERROR_OPERATION = Object.freeze({
  ...
  AUTH_CONFIRMATION_RESEND: "auth_confirmation_resend",
  AUTH_PASSWORD_RECOVERY_REQUEST: "auth_password_recovery_request",
  AUTH_PASSWORD_RECOVERY_UPDATE: "auth_password_recovery_update",
  AUTH_SIGN_IN: "auth_sign_in",
  AUTH_SIGN_OUT: "auth_sign_out",
  AUTH_SIGN_UP: "auth_sign_up",
  FEEDBACK_SAVE: "feedback_save",
  GUIDE_LOAD: "guide_load",
...
const USER_ERROR_MESSAGES = Object.freeze({
  ...
  [ERROR_OPERATION.AUTH_CONFIRMATION_RESEND]: "確認メールを再送できませんでした。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.AUTH_PASSWORD_RECOVERY_REQUEST]: "パスワード再設定メールを送信できませんでした。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.AUTH_PASSWORD_RECOVERY_UPDATE]: "パスワードを変更できませんでした。時間をおいてもう一度お試しください。",
  ...
  [ERROR_OPERATION.GUIDE_LOAD]: "入村案内の読み込みに失敗しました。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.GUIDE_SAVE]: "入村案内の保存に失敗しました。時間をおいてもう一度お試しください。",
  ...
  [ERROR_OPERATION.NOTIFICATION_LOAD]: "Re:Connectの読み込みに失敗しました。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.NOTIFICATION_SAVE]: "Re:Connectの更新に失敗しました。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.ONBOARDING_LOAD]: "入村案内の続きの読み込みに失敗しました。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.ONBOARDING_SAVE]: "入村案内の進捗を保存できませんでした。もう一度お試しください。",
  ...
  [ERROR_OPERATION.REPORT_LOAD]: "観測局の読み込みに失敗しました。時間をおいてもう一度お試しください。",
  [ERROR_OPERATION.REPORT_SAVE]: "観測局の更新に失敗しました。時間をおいてもう一度お試しください。",
